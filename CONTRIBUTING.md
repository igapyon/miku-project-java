...
Keep changes traceable to `vendor/mikuproject` when they affect shared product
...
Do not edit `vendor/mikuproject` during ordinary Java maintenance. Treat it as
