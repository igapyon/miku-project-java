...
vendored Node `v0.12.0` の `vendor/miku-project/docs/miku-project-ai-json-spec.md` を、Maven の `process-resources` で classpath にコピーして読む。`mikuproject_workbook_json` などの確立済み交換形式 ID は変更しない。
